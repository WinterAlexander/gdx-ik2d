...
public class FixedBaseAbsoluteBaseBoneJointConstraints extends CalikoDemoStructure2D {
	...
	public void setup() {
		...
		basebone = new FabrikBone2D(new Vector2(0.0f, -boneLength), new Vector2(0.0f, 0.0f) );
		...
		chain.setBaseboneConstraintUV( new Vector2(0.0f, 1.0f) );

		// Create and add the second bone - 50 clockwise, 90 anti-clockwise
		chain.addConsecutiveConstrainedBone(new Vector2(0.0f, 1.0f), boneLength, 50.0f, 90.0f);
		
		// Create and add the third bone - 75 clockwise, 90 anti-clockwise
		chain.addConsecutiveConstrainedBone(new Vector2(0.0f, 1.0f), boneLength, 75.0f, 90.0f);
