...
public class Point2D
{
	...
	private static final int VERTEX_COMPONENTS = 2; // Each vertex has an x, y and z component...
	...
	private static final String VERTEX_SHADER_SOURCE =
			...
			"	gl_Position = mvpMatrix * vec4(vertexLocation, 0.0, 1.0); // Project our geometry"                  + newLine +
			"}";
